...
```json
{
    "Certificates": [
        {
            "Data": "/tmp/edge_configuration/update_cert.der",
            "Format": "der",
            "Name": "mbed.UpdateAuthCert"
        },
        {
            "Data": "/tmp/edge_configuration/LwM2MDeviceCert.der",
            "Format": "der",
            "Name": "mbed.LwM2MDeviceCert"
        },
        {
            "Data": "/tmp/edge_configuration/Lwm2mServerCACert.der",
            "Format": "der",
    ...
    "Keys": [
        {
            "Data": "/tmp/edge_configuration/LwM2MDevicePrivateKey.der",
            "Format": "der",
...
* `-v $PWD/edge_configuration:/tmp/edge_configuration`: Mounts the host directory containing your JSON config along with certificates and keys into the container.
