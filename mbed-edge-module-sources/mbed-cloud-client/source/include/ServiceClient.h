...
public:
    ...
    */
    ...
    /**
     * \brief Restarts the registration process.
     * Note: calling this method should be avoided because current subscriptions are cancelled.
     * It is recommended to use a method which just updates the current registation.
     */
    void reregister();
