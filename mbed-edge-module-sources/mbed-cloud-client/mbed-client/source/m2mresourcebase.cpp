                                ...
                                const uint32_t value_length)
{
    ...
    if( value != NULL && value_length > 0 ) {
        ...
        if (value_copy) {
            if (_value_set_callback) {
                _value_set_callback((const M2MResourceBase*)this, value_copy, value_length);
            }
            else {
...

{
    ...
    if( value != NULL && value_length > 0 ) {
        success = true;
        if (_value_set_callback) {
            _value_set_callback((const M2MResourceBase*)this, value, value_length);
        }
        else {
