...
#if defined(MBED_EDGE_BUILD_CFG_MBED_TRACE_MEM)
#define MBED_TRACE_MEM_INCLUDE      MBED_EDGE_BUILD_CFG_MBED_TRACE_MEM_INCLUDE
#define MBED_TRACE_MEM_ALLOC        MBED_EDGE_BUILD_CFG_MBED_TRACE_MEM_ALLOC
#define MBED_TRACE_MEM_FREE         MBED_EDGE_BUILD_CFG_MBED_TRACE_MEM_FREE
#else /* MBED_EDGE_BUILD_CFG_MEMLIB */
// Default options
...
#endif
#endif /* MBED_EDGE_BUILD_CFG_MEMLIB */
...
#elif defined MBED_EDGE_BUILD_CFG_MBED_TRACE_LINE_LENGTH
#warning MBED_EDGE_BUILD_CFG_MBED_TRACE_LINE_LENGTH is deprecated and will be removed in the future! Use MBED_TRACE_LINE_LENGTH instead.
#define DEFAULT_TRACE_LINE_LENGTH         MBED_EDGE_BUILD_CFG_MBED_TRACE_LINE_LENGTH
#else
...
#elif defined MBED_EDGE_BUILD_CFG_MBED_TRACE_TMP_LINE_LEN
#warning The MBED_EDGE_BUILD_CFG_MBED_TRACE_TMP_LINE_LEN flag is deprecated and will be removed in the future! Use MBED_TRACE_TMP_LINE_LENGTH instead.
#define DEFAULT_TRACE_TMP_LINE_LEN        MBED_EDGE_BUILD_CFG_MBED_TRACE_TMP_LINE_LEN
#elif defined MBED_EDGE_BUILD_CFG_MTRACE_TMP_LINE_LEN
#warning The MBED_EDGE_BUILD_CFG_MTRACE_TMP_LINE_LEN flag is deprecated and will be removed in the future! Use MBED_TRACE_TMP_LINE_LENGTH instead.
#define DEFAULT_TRACE_TMP_LINE_LEN        MBED_EDGE_BUILD_CFG_MTRACE_TMP_LINE_LEN
#else
