 ...
 *      }
 * \endcode
 * Activate with compiler flag: MBED_EDGE_BUILD_CFG_MBED_TRACE
 * Configure trace line buffer size with compiler flag: MBED_EDGE_BUILD_CFG_MBED_TRACE_LINE_LENGTH. Default length: 1024.
...
#ifndef MBED_EDGE_BUILD_CFG_MBED_TRACE
#define MBED_EDGE_BUILD_CFG_MBED_TRACE 0
#endif

#ifndef MBED_EDGE_BUILD_CFG_MBED_TRACE_FEA_IPV6
#define MBED_EDGE_BUILD_CFG_MBED_TRACE_FEA_IPV6 1
#else
#warning MBED_EDGE_BUILD_CFG_MBED_TRACE_FEA_IPV6 is deprecated and will be removed in the future! Use MBED_CONF_MBED_TRACE_FEA_IPV6 instead.
#define MBED_CONF_MBED_TRACE_FEA_IPV6 MBED_EDGE_BUILD_CFG_MBED_TRACE_FEA_IPV6
#endif
...
#ifndef TRACE_GROUP
#ifdef MBED_EDGE_BUILD_CFG_MBED_TRACE_GROUP
#define TRACE_GROUP_STR_HELPER(x) #x
#define TRACE_GROUP_STR(x) TRACE_GROUP_STR_HELPER(x)
#define TRACE_GROUP TRACE_GROUP_STR(MBED_EDGE_BUILD_CFG_MBED_TRACE_GROUP)
#endif
#endif
