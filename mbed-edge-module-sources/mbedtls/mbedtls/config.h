...
#define MBED_EDGE_BUILD_CFG_MBEDTLS_TARGET_CONFIG_FILE "mbedtls/target_config.h"

#if defined(TARGET_LIKE_MBED) && defined(MBED_EDGE_BUILD_CFG_MBEDTLS_TARGET_CONFIG_FILE)
#include MBED_EDGE_BUILD_CFG_MBEDTLS_TARGET_CONFIG_FILE
#endif
 ...
 * - with yotta the prefix MBED_EDGE_BUILD_CFG_ is forced
 * - without yotta is looks weird to have a YOTTA prefix.
 */
#if defined(MBED_EDGE_BUILD_CFG_MBEDTLS_USER_CONFIG_FILE)
#include MBED_EDGE_BUILD_CFG_MBEDTLS_USER_CONFIG_FILE
