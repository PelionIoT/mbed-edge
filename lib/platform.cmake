...
set(CMAKE_OS_PATH ${CMAKE_SOURCE_DIR}/lib/pal-platform/OS/${MBED_CLOUD_CLIENT_OS}/${MBED_CLOUD_CLIENT_OS}.cmake)
...
if ("${MBED_CLOUD_CLIENT_NATIVE_SDK}" STREQUAL "True")
    ...
    set(CMAKE_SDK_PATH ${CMAKE_SOURCE_DIR}/lib/pal-platform/SDK/${MBED_CLOUD_CLIENT_SDK}/${MBED_CLOUD_CLIENT_SDK}.cmake)
endif()
...
foreach(MW ${MBED_CLOUD_CLIENT_MIDDLEWARE})
    set(CMAKE_MW_PATH ${CMAKE_SOURCE_DIR}/cmake/pal-platform-cmake/${MW}.cmake)
if(EXISTS ${CMAKE_MW_PATH})
        message("MW PATH ${CMAKE_MW_PATH}")
