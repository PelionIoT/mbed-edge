/*
 * This file contains modification of original Apache APR Base64 encoder.
 */
 ...
 *
 * The decoding function takes any non-valid char (such as whitespace, \0
 * or anything non A-Z,0-9 as terminal).
 *
