...
if(FOTA_ENABLE AND NOT MBED_CLOUD_CLIENT_CURL_DYNAMIC_LINK)
  ...
  # print MBED_CLOUD_CLIENT_USE_OPENSSL
  message(STATUS "MBED_CLOUD_CLIENT_USE_OPENSSL: ${MBED_CLOUD_CLIENT_USE_OPENSSL}")
  if(MBED_CLOUD_CLIENT_USE_OPENSSL)
    SET (PLATFORM_TARGET x86_x64_NativeLinux_openssl)
  else()
