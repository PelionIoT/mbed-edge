...
if (${FIRMWARE_UPDATE})
  ...
  if (FOTA_ENABLE)
    ...
    if (DEFINED SUBDEVICE_FIRMWARE_DOWNLOAD_LOCATION)
      ...
      MESSAGE(WARNING "Using firmware update directory: ${SUBDEVICE_FIRMWARE_DOWNLOAD_LOCATION}")
    endif()
  ...
  if (NOT FOTA_ENABLE)
     ...
     message("WARNING: Update Client Hub is Depreceated, Use new Fota framework (FOTA_ENABLE=ON) instead")
