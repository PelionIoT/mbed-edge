...
if (NOT DEFINED TARGET_CONFIG_ROOT)
   if (WIN32)
     include ("cmake/targets/windows.cmake")
   else ()
...
if (${FIRMWARE_UPDATE})
  ...
  if (FOTA_ENABLE)
    ...
    if (NOT DEFINED FOTA_SCRIPT_DIR)
      SET (FOTA_SCRIPT_DIR \"/opt/izuma\")
    endif()
    if (NOT DEFINED FOTA_INSTALL_MAIN_SCRIPT)
      SET (FOTA_INSTALL_MAIN_SCRIPT \"fota_update_activate.sh\")
    endif()
    if (NOT DEFINED FOTA_INSTALL_SCRIPT)
      SET (FOTA_INSTALL_SCRIPT \"fota_update_activate.sh\")
    endif()
    if (NOT DEFINED FOTA_VERIFY_SCRIPT)
      SET (FOTA_VERIFY_SCRIPT \"fota_update_verify.sh\")
    endif()
    ...
    add_definitions(-DMBED_CLOUD_CLIENT_FOTA_RESUME_SUPPORT=FOTA_RESUME_SUPPORT_RESUME)
